  ...
  return (
    <div className="bg-white pt-16 pb-24">
      <div className="flex flex-col w-full lg:flex-row place-items-center p-2" >
        <div className="grid flex-grow card place-items-center w-full">
          <img
            className="border-8 border-white"
            src="https://img.freepik.com/free-vector/female-student-listening-webinar-online_74855-6461.jpg" alt="" 
          />
        </div>
        <div className="p-8">
